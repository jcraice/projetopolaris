...
- ~~**Tema escuro apenas.** Não existe versão clara.~~ **Revogado em 29/07/2026 pela autora**, depois que o plano terminou: existe um tema claro, escolhido por botão na navegação e guardado no navegador, sem aurora e com os dois acentos escurecidos para caberem em fundo claro. Ver `docs/verificacao-visual.md`.
