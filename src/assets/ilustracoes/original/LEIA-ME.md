...
escuro, fundo transparente. **Nenhuma página do site aponta para eles** — o que
entra nas páginas são as duas versões geradas na pasta acima, uma por tema.
...
O script corta na caixa do desenho, reduz para a largura de exibição e inverte o
traço para a versão do tema escuro — preservando as partes coloridas, que são
cor escolhida e não traço.
