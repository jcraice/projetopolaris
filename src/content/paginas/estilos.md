...
## Combinações Entre Subgêneros

Um dos encantos da ficção científica é a possibilidade de combinar estilos e subgêneros, criando narrativas únicas e inovadoras. Criei alguns exemplos:

**Cyberpunk + Viagem no Tempo**: Linhas temporais manipuladas por hackers e corporações que usam a tecnologia para reescrever a história em benefício próprio.

**Invasão Alienígena + Distopia**: Regimes autoritários que exploram a presença inimiga para reforçar o controle social, enquanto a população é usada como recurso na guerra.

**Space Opera + Cyberpunk**: Planetas inteiros transformados em metrópoles digitais, governados por corporações interestelares que controlam desde os dados até as rotas comerciais.

**Distopia + Pós apocalíptico**: Regimes autoritários erguidos das cinzas de uma catástrofe, governando os sobreviventes em meio à escassez e ao medo.
